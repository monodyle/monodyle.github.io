...
Dưới sự mời gọi của cả CEO — anh Trung và Frontend Lead — anh quý, kèm theo đó là động lực thôi thúc làm giàu ở trong mình, mình đầu quân cho **Sky Mavis** — một công ty công nghệ blockchain. Vậy là mình join Sky Mavis với cái title là *Frontend Engineer*.
...
Giống như nhiều ngôn ngữ khác, Rust cũng có một cái tổ chức và quản lý các gói phụ thuộc (dependencies) của nó. Như Node, bạn có `npm`, hay `mix` của Elixir, thì Rust có `cargo`, và các dependenciesdepen của cargo được gọi là **crate**.
...
Được javscript chiều chuộng khá nhiều, mình đã dần quen với việc khai báo biến lung tung và mutable mọi thứ một cách thoải mái. Cơ mà từ lúc viết Rust, mình liên tục bị cái console chửi vì cái compier khá khó tính trong việc sử dụng và khai báo biến.
