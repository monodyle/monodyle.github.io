...
<image title="Học toán để làm gì?" src="/assets/blog/toan-va-tin/01.jpg" />
...
<image title="Say no with Math" src="/assets/blog/toan-va-tin/02.jpg" />
...
Gần đây mình có gặp một vấn đề về algorithm trong _canvas_ cần phải implement: Làm sao để detect 2 object chạm vào nhau, sau đó áp dụng _chuyển động đàn hồi_ (_elastic collision_) để di chuyển 2 object đó sau va chạm. Thế là vò đầu bứt tai đi đọc đủ thứ tài liệu.
...
<image title="Collision detection" src="/assets/blog/toan-va-tin/04.jpg" />
...
<image title="Collision detection" src="/assets/blog/toan-va-tin/05.jpg" />
...
<image
  title="Kết quả"
  src="/assets/blog/toan-va-tin/translational_motion.gif"
/>
...
<youtube
  src="https://www.youtube.com/embed/ogiY6xt_TRM"
...
<image
  title="Va chạm giữa 2 vật thể cùng khối lượng"
...
<image title="Hệ toạ độ ban đầu" src="/assets/blog/toan-va-tin/08.jpg" />
...
<image title="Kiểu như thế này" src="/assets/blog/toan-va-tin/03.jpg" />

Vì vậy khi xoay hệ toạ độ lại bằng một góc $a$ radian, chúng ta có thể tính được vận tốc vật trước va chạm

<image title="Hệ toạ độ sau khi xoay" src="/assets/blog/toan-va-tin/09.jpg" />
